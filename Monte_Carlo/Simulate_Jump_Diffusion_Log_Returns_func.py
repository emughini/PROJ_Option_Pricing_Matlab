...
# Simulate_Jump_Diffusion_Log_Returns_func.m

    
@function
def Simulate_Jump_Diffusion_Log_Returns_func(N_sim=None,dt=None,r=None,q=None,sigma=None,jumpModel=None,jumpParams=None,*args,**kwargs):
    varargin = Simulate_Jump_Diffusion_Log_Returns_func.varargin
    nargin = Simulate_Jump_Diffusion_Log_Returns_func.nargin
...
# Simulate_Jump_Diffusion_Log_Returns_func.m:36
        kappa=jumpParams.kappa
# Simulate_Jump_Diffusion_Log_Returns_func.m:37
        Zeta=r - q - dot(lambda_,kappa)
# Simulate_Jump_Diffusion_Log_Returns_func.m:39
        lamdt=dot(lambda_,dt)
# Simulate_Jump_Diffusion_Log_Returns_func.m:40
        if jumpModel == 1:
            muJ=jumpParams.muJ
# Simulate_Jump_Diffusion_Log_Returns_func.m:43
            sigJ=jumpParams.sigJ
# Simulate_Jump_Diffusion_Log_Returns_func.m:44
            JumpFunc=lambda n=None: sum(muJ + dot(sigJ,randn(n,1)))
# Simulate_Jump_Diffusion_Log_Returns_func.m:45
        else:
            if jumpModel == 2:
                p_up=jumpParams.p_up
# Simulate_Jump_Diffusion_Log_Returns_func.m:48
                eta1=jumpParams.eta1
# Simulate_Jump_Diffusion_Log_Returns_func.m:49
                eta2=jumpParams.eta2
# Simulate_Jump_Diffusion_Log_Returns_func.m:50
                JumpFunc=lambda n=None: sum(DoubleExpoRnd(n,p_up,eta1,eta2))
# Simulate_Jump_Diffusion_Log_Returns_func.m:51
            else:
                if jumpModel == 3:
                    p_up=jumpParams.p_up
# Simulate_Jump_Diffusion_Log_Returns_func.m:54
                    a1=jumpParams.a1
# Simulate_Jump_Diffusion_Log_Returns_func.m:55
                    b1=jumpParams.b1
# Simulate_Jump_Diffusion_Log_Returns_func.m:55
                    a2=jumpParams.a2
# Simulate_Jump_Diffusion_Log_Returns_func.m:56
                    b2=jumpParams.b2
# Simulate_Jump_Diffusion_Log_Returns_func.m:56
                    JumpFunc=lambda n=None: sum(MixedNormalRnd(n,p_up,a1,b1,a2,b2))
# Simulate_Jump_Diffusion_Log_Returns_func.m:57
    else:
        Zeta=r - q
# Simulate_Jump_Diffusion_Log_Returns_func.m:60
    
    ##################################################################################
    
    Sigsqdt=dot(sigma,sqrt(dt))
# Simulate_Jump_Diffusion_Log_Returns_func.m:65
    drift=dot((Zeta - dot(0.5,sigma ** 2)),dt)
# Simulate_Jump_Diffusion_Log_Returns_func.m:66
    if jumpModel == 0:
        Rets=drift + dot(Sigsqdt,randn(N_sim,1))
# Simulate_Jump_Diffusion_Log_Returns_func.m:69
    else:
        Poi=PoissonRnd(N_sim,lamdt)
# Simulate_Jump_Diffusion_Log_Returns_func.m:71
        for n in arange(1,N_sim).reshape(-1):
            if Poi(n) > 0:
                Poi[n]=JumpFunc(Poi(n))
# Simulate_Jump_Diffusion_Log_Returns_func.m:74
        Rets=drift + Poi + dot(Sigsqdt,randn(N_sim,1))
# Simulate_Jump_Diffusion_Log_Returns_func.m:78
